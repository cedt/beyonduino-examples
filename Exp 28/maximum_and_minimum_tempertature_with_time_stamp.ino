...
int h,s,m,x,y,t,m1,ma,mn,x1,x2,n,rx,l,k,sw=A2,i=0,u=0;
...
void loop() 
{
   ...
   {  
         ...
         { 
           //Serial.println("\t");
           c[x][0]= ee.readByte(a[x][0]);
           c[x][1]=ee.readByte(a[x][1]);
           c[x][2]=ee.readByte(a[x][2]);
           c[x][3]=ee.readByte(a[x][3]);
           if(ma<c[x][0])
           {
             ma=c[x][0];
             x1=x;
         ...
         Serial.print("maximum remperature=");
         Serial.print(ma);
         Serial.print("@");
         Serial.print(c[x1][1]);
         Serial.print(":");
         Serial.print(c[x1][2]);
         Serial.print(":");
         Serial.println(c[x1][3]);
         
         Serial.print("minimum remperature=");
         Serial.print(mn);
         Serial.print("@");
         Serial.print(c[x2][1]);
         Serial.print(":");
